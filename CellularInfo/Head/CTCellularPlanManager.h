...
//-(void)didSelectPlanItem:(CTCellularPlanItem *)planItem isEnable:(BOOL)arg2 completion:(/*^block*/id)arg3;
-(void)didSelectPlanItem:(CTCellularPlanItem *)planItem isEnable:(BOOL)arg2 completion:(void (^)(BOOL success, NSError * error))completion;
-(int)didSelectPlanItem:(CTCellularPlanItem *)planItem isEnable:(BOOL)enable; // 开启或者关闭某张卡
